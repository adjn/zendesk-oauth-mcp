...
var (
	...
	// ZENDESK_BROWSER_USER_AGENT overrides the auto-detected browser User-Agent.
	// When unset, the UA is derived from the browser that provided the cookie.
	zendeskUserAgent = os.Getenv("ZENDESK_BROWSER_USER_AGENT")
)
